...
report:
	...
	@forge coverage >> test/coverage/CoverageReport.txt
	@echo "Coverage debug report generated in test/coverage/CoverageReportDebug.txt"
	@echo "Coverage report generated in test/coverage/CoverageReport.txt"

# Reading an lcov.info file is hard, should be converted to html or with the VSCode extension.
lcov:
